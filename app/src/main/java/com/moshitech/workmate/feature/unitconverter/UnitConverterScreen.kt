...
fun UnitConverterScreen(
    ...
    var selectedHistoryItem by remember {
        mutableStateOf<com.moshitech.workmate.feature.unitconverter.data.local.UnitConversionHistoryEntity?>(
            null
        )
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            // Search Bar (Fixed at top with animation)
