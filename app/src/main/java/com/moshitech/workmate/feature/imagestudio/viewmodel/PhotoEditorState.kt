...
data class TextLayer(
        ...
        val gradientColors: List<Int> =
                listOf(android.graphics.Color.BLUE, android.graphics.Color.MAGENTA),
...
sealed class DrawAction {
    ...
    data class Shape(val shape: com.moshitech.workmate.feature.imagestudio.viewmodel.Shape) :
            DrawAction()
}
...
data class PhotoEditorUiState(
        ...
        val editHistory: List<com.moshitech.workmate.feature.imagestudio.data.EditOperation> =
                emptyList(),
